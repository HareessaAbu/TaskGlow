<template>
    <div class="p-4 flex flex-row items-center w-full justify-between">
        <div class="flex flex-row flex-start relative text-black">
            <div class="flex leading-6 h-7 items-center">
            ...
            <div class="leading-6 ml-3">
                <label :for="`completed${index}`" class="font-medium leading-6">{{ task.title }}</label>
